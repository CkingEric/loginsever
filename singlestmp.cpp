...
SingleStmp *SingleStmp::instance()
{
    return _instance;
}

void SingleStmp::send(QByteArray recvaddr, QString subject, QString content)
{
...
SingleStmp::SingleStmp()
{
    ...
    this->clientsocket->bind(QHostAddress::Any,8888);
}

SingleStmp* SingleStmp::_instance=new SingleStmp();
